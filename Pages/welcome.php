...
<div id="allcontent">
	...
	<div id="header">
		<a href="#"  > <span class ="header_logo"> <img src="../Images/League.jpg" title="Home" height="70" width='70' ></span></a> 
							...
							<div id="tablecontainer">	
								<div id="tablerow">
									...
									<h2 id="ddt2">EXTRAS</h2>
										<ol>
											<li>Saurez</li>
											<li>Hugo Campagnaro</li>
											<li>Ezequiel Lavezzi</li>
										</ol>
									</div>	
									</div>
							</div>	
  ...
  <li><a href="signout.php">Sign Out</a></li>
			...
			<br>
			<iframe src="start.php" width="100%" height="600px" frameborder="0" name="names"></iframe> 
	<?php
	include 'connect1.php';
	$a="update a1 set goal_scored=0,goal_diff=0,points=0 where 1";
	$link->query($a);
	$a="update b1 set goal_scored=0,goal_diff=0,points=0 where 1";
	$link->query($a);
	$a="update c1 set goal_scored=0,goal_diff=0,points=0 where 1";
	$link->query($a);
	$a="update d1 set goal_scored=0,goal_diff=0,points=0 where 1";
	$link->query($a);
	$sql44="delete from quarter_final where 1";
	$link->query($sql44);
	$sql44="delete from semi_final where 1";
	$link->query($sql44);
	$sql44="delete from final where 1";
	$link->query($sql44);
	?>
</div>	
</body>
