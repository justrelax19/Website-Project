		 ...
		 <div id='tablecontainer'>
			<div id='content'>
			  <div id="tablerow">
				...
				<div id='stats1'>
				<p>
					<span class='no'>16</span> <span id='stats'>FIFA World Cup appearances</span><br>
					<span class='no'>2</span>  <span id='stats'>FIFA World Cup victories</span><br>
					<span class='no'>14</span> <span id='stats'>Continental titles</span><br>
					<span class='no'>9</span> <span id='stats'>Other Titles</span><br>
				</p>
				</div>
				<div id='stats2'>
				<p>
					<span class='info'>Foundation year:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1893<br>
					<span class='info'>Affiliated since:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1912<br>
					<span class='info'>President:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SEGURA Luis<br>
					<span class='info'>General Secretary:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SILVA Miguel<br>
					<span class='info'>National Team Coach MEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gerardo MARTINO<br>
					<span class='info'>National Team Coach WOMEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NICOSIA Luis<br>
				</P>
				</div>
				</div>
				<div id='venue'>
				...
				<p>
					...
					<table border="2" border color="yellow" align="center">
						<?php
							...
							$sql = "select * from stadium where place='Buenos Aires'";
				...
				<div id='current'>
					<h2>Current Squad </h2>
						...
						<?php
						include("connect1.php");
						$sql = "select * from player where tid='T1'";
						$extract=$link->query($sql);
						if(mysqli_query($link, $sql)){
						?>
						<tr><th><b> 
