			...
			<div id='content'>
			  <div id="tablerow">
				...
				<p>
					...
					<span class='info'>President:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DE KEERSMAECKER Francois<br>
					<span class='info'>National Team Coach MEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WILMOTS Marc<br>
					<span class='info'>National Team Coach WOMEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SERNEELS Ives<br>
				</P>
				</div>
				</div>
				<div id='venue'>
				...
				<p>
					...
					<table border="2" border color="yellow" align="center">
						<?php
							...
							$sql = "select * from stadium where sid IN('S4','S5')";
				...
				<div id='current'>
					<h2>Current Squad </h2>
						...
						<?php
						include("connect1.php");
						$sql = "select * from player where tid='T9'";
						$extract=$link->query($sql);
						if(mysqli_query($link, $sql)){
						?>
						<tr><th><b> 
