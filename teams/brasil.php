			...
			<div id='tablecontainer'>
				<div id='content'>
						...
						<br><h2>QUICK STATS -</h2>
							<div id='stats1'>
								<p>
									...
									<span class='no'>20</span> <span id='stats'>FIFA World Cup appearances</span><br>
									<span class='no'>5</span>  <span id='stats'>FIFA World Cup victories</span><br>
									<span class='no'>8</span> <span id='stats'>Continental titles</span><br>
									<span class='no'>21</span> <span id='stats'>Other Titles</span><br>
								</p>
							</div>
							<div id='stats2'>
								<p>
									...
									<span class='info'>President:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DEL NERO Marco Polo<br>
									<span class='info'>General Secretary:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FELDMAN Walter<br>
									<span class='info'>National Team Coach MEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DUNGA<br>
									<span class='info'>National Team Coach WOMEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VADAO<br>
								</P>
							</div>
					</div>
					<div id='venue'>
					...
					<?php
							...
							$sql = "select * from stadium where sid IN('S2','S3')";
				...
				<div id='current'>
					<h2>Current Squad </h2>
						...
						<?php
						include("connect1.php");
						$sql = "select * from player where tid='T2'";
						$extract=$link->query($sql);
						if(mysqli_query($link, $sql)){
						?>
						<tr><th><b> 
