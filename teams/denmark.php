...
<html>
	...
	<body>
		...
		<div id="headerContainer">
			<div id="header">
				<a href="../pages/index.php" > <span class ="header_logo"> <img src="../Images/League.jpg" title="Home" height="70" width='70' ></span></a> 
				...
				<a href="../teams/brazil.php"> <span class ="header_img"> <img src="../Images/bra.gif"  title="Brazil" height="30" width="30" ></span></a>
				...
				<a href="../teams/sweden.php"> <span class ="header_img"> <img src="../Images/swe.gif"  title="Sweden" height="30" width="30" ></span></a>
				<a href="../teams/uruguay.php"> <span class ="header_img"> <img src="../Images/uru.gif"  title="Uruguay" height="30" width="30" ></span></a><br>
			</div>
			<div id='cssmenu'>
			<ul>
			   <li><a href='../pages/index.php'><span>HOME</span></a></li>
								...
								<div id="tablerow2">
									...
									<h2 id="ddt2">RECENT</h2>
										<ol>
											...
											<li>Only Grids & Sliders</li>
										</ol>
									</div>
									<div id="extras">	
									<h2 id="ddt2">EXTRAS</h2>
										<ol>
											<li>Demo Homepage</li>
											<li>Full-width(No Sidebar)</li>
											<li>Only Grids & Sliders</li>
							...
							<div id="tablecontainer2">	
								<div id="tablerow2">
									...
									<div id="wwd">		
										...
										<a href="wwd.php"><img width="300" height=auto src="../Images/wwd.png"></a>
									</div>
									
									<div id="wwr">	
										<h2 id="ddt4">WHO WE ARE</h2>
										<a href="wwr.php"><img width="300" height=auto src="../Images/back/image_1.jpg"></a>
			...
			<font color="white"><h1>Denmark</h1></font>
		 <div id='tablecontainer'>
			<div id='content'>
			  <div id="tablerow">
				<br><h2>QUICK STATS -</h2>
				<div id='stats1'>
				<p>
					<span class='no'>4</span> <span id='stats'>FIFA World Cup appearances</span><br>
					<span class='no'>0</span>  <span id='stats'>FIFA World Cup victories</span><br>
					<span class='no'>1</span> <span id='stats'>Continental titles</span><br>
					<span class='no'>1</span> <span id='stats'>Other Titles</span><br>
				</p>
				</div>
				<div id='stats2'>
				<p>
					<span class='info'>Foundation year:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1889<br>
					<span class='info'>Affiliated since:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1904<br>
					<span class='info'>President:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CHRISTENSEN Jesper Moller<br>
					<span class='info'>General Secretary:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BRETTON MEYER Claus<br>
					<span class='info'>National Team Coach MEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OLSEN Morten<br>
					<span class='info'>National Team Coach WOMEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NIELSEN Niels<br>
				</P>
				</div>
				</div>
				<div id='venue'>
				...
				<p>
					...
					<table border="2" border color="yellow" align="center">
						<?php
							include("connect1.php");
							$sql = "select * from stadium where sid IN('S8','S9')";
						...
						?>
							...
							<?php echo "MATCHES PLAYED: "?> 
							</b><th><b>
							<?php echo "No. of SEATS"?>
							</b><th><b>
							<?php echo "PLACE"?>
							</b></tr>
						<?php
							...
							{
							?>		
							<tr><td><?php	echo $sql["name"] ;?>
							<td><?php echo $sql["Matches played"];?>
							<td><?php echo $sql["no_seats"];?>
							<td><?php echo $sql["place"]; ?>
							</tr>
				...
				<div id='current'>
					<h2>Current Squad </h2>
						...
						<?php
						include("connect1.php");
						$sql = "select * from player where tid='T3'";
						$extract=$link->query($sql);
						if(mysqli_query($link, $sql)){
						?>
						<tr><th><b> 
					...
					<tr><td><?php	echo $sql["name"] ;?>
						<td><?php echo $sql["age"];?>
						<td><?php echo $sql["match_played"];?>
						<td><?php echo $sql["goals"]; ?>
						<td><?php echo $sql["skill_level"]; ?>
						<td><?php echo $sql["position"]; ?>
						</tr>
