...
<html>
	...
	<body>
		...
		<a href="../teams/uruguay.php"  > <span class ="header_img"> <img src="../Images/uru.gif"  title="Uruguay" height="30" width="30" ></span></a><br>
			...
			<font color="blue"><h1>France</h1></font>
		 <div id='tablecontainer'>
			<div id='content'>
			  <div id="tablerow">
				...
				<div id='stats1'>
				<p>
					<span class='no'>14</span> <span id='stats'>FIFA World Cup appearances</span><br>
					<span class='no'>1</span>  <span id='stats'>FIFA World Cup victories</span><br>
					<span class='no'>2</span> <span id='stats'>Continental titles</span><br>
					<span class='no'>7</span> <span id='stats'>Other Titles</span><br>
				</p>
				</div>
				<div id='stats2'>
				<p>
					<span class='info'>Foundation year:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1919<br>
					<span class='info'>Affiliated since:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1904<br>
					<span class='info'>President:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LE GRAET Noel<br>
					<span class='info'>General Secretary:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HENRIQUES Brigitte<br>
					<span class='info'>National Team Coach MEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DESCHAMPS Didier<br>
					<span class='info'>National Team Coach WOMEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BERGEROO Philippe<br>
				</P>
				</div>
				</div>
				<div id='venue'>
...
<?php
							...
							$sql = "select * from stadium where sid IN('S13','S14')";
				...
				<div id='current'>
					<h2>Current Squad </h2>
						...
						<?php
						include("connect1.php");
						$sql = "select * from player where tid='T4'";
						$extract=$link->query($sql);
						if(mysqli_query($link, $sql)){
						?>
						<tr><th><b> 
