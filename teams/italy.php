...
<html>
	...
	<body>
		...
		<a href="../teams/uruguay.php"  > <span class ="header_img"> <img src="../Images/uru.gif"  title="Uruguay" height="30" width="30" ></span></a><br>
			...
			<br><br><br><br><br><br><br>
			<font color="red"><h1>Italy</h1></font>
		 <div id='tablecontainer'>
			<div id='content'>
			  <div id="tablerow">
				...
				<div id='stats1'>
				<p>
					<span class='no'>18</span> <span id='stats'>FIFA World Cup appearances</span><br>
					<span class='no'>4</span>  <span id='stats'>FIFA World Cup victories</span><br>
				...
				<div id='stats2'>
				<p>
					<span class='info'>Foundation year:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1898<br>
					<span class='info'>Affiliated since:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1905<br>
					<span class='info'>President:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TAVECCHIO Carlo<br>
					<span class='info'>General Secretary:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UVA Michele<br>
					<span class='info'>National Team Coach MEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CONTE Antonio<br>
					<span class='info'>National Team Coach WOMEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CABRINI Antonio<br>
				</P>
				</div>
				</div>
				<div id='venue'>
				...
				<p>
					...
					<table border="2" border color="yellow" align="center">
							...
							$sql = "select * from stadium where sid IN('S17','S18')";
				...
				<div id='current'>
					<h2>Current Squad </h2>
						...
						<?php
						include("connect1.php");
						$sql = "select * from player where tid='T14'";
						$extract=$link->query($sql);
						if(mysqli_query($link, $sql)){
						?>
						<tr><th><b> 
