...
<html>
	...
	<body>
		...
		<a href="../teams/uruguay.php"  > <span class ="header_img"> <img src="../Images/uru.gif"  title="Uruguay" height="30" width="30" ></span></a>
			</div>
			<div id='cssmenu'>
			<ul>
			...
			<font color="blue"><h1>Netherlands</h1></font>
		 <div id='tablecontainer'>
			<div id='content'>
			  <div id="tablerow">
				...
				<div id='stats1'>
				<p>
					<span class='no'>10</span> <span id='stats'>FIFA World Cup appearances</span><br>
					...
					<span class='no'>0</span> <span id='stats'>Other Titles</span><br>
				</p>
				</div>
				<div id='stats2'>
				<p>
					...
					<span class='info'>President:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VAN PRAAG Michael<br>
					<span class='info'>General Secretary:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VAN OOSTVEEN Bert<br>
					<span class='info'>National Team Coach MEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BLIND Danny<br>
					<span class='info'>National Team Coach WOMEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VAN DER LAAN Arjan<br>
				</P>
				</div>
				</div>
				<div id='venue'>
...
<?php
							...
							$sql = "select * from stadium where sid IN('S19','S20')";
				...
				<div id='current'>
					<h2>Current Squad </h2>
						...
						<?php
						include("connect1.php");
						$sql = "select * from player where tid='T5'";
						$extract=$link->query($sql);
						if(mysqli_query($link, $sql)){
						?>
						<tr><th><b> 
