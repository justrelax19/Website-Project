...
<html>
	...
	<body>
		...
		<a href="../teams/uruguay.php"  > <span class ="header_img"> <img src="../Images/uru.gif"  title="Uruguay" height="30" width="30" ></span></a><br>
			...
			<font color="red"><h1>Portugal</h1></font>
		 <div id='tablecontainer'>
			<div id='content'>
			  <div id="tablerow">
				...
				<div id='stats1'>
				<p>
					<span class='no'>6</span> <span id='stats'>FIFA World Cup appearances</span><br>
					...
					<span class='no'>3</span> <span id='stats'>Other Titles</span><br>
				</p>
				</div>
				<div id='stats2'>
				<p>
					<span class='info'>Foundation year:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1914<br>
					<span class='info'>Affiliated since:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1923<br>
					<span class='info'>President:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GOMES Fernando<br>
					<span class='info'>General Secretary:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CRAVEIRO Tiago<br>
					<span class='info'>National Team Coach MEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SANTOS Fernando<br>
					<span class='info'>National Team Coach WOMEN:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FRANCISCO NETO<br>
				</P>
				</div>
				</div>
				<div id='venue'>
				...
				<p>
					...
					<table border="2" border color="yellow" align="center">
						<?php
							...
							$sql = "select * from stadium where sid IN('S23','S24')";
				...
				<div id='current'>
					<h2>Current Squad </h2>
						...
						<?php
						include("connect1.php");
						$sql = "select * from player where tid='T6'";
						$extract=$link->query($sql);
						if(mysqli_query($link, $sql)){
						?>
						<tr><th><b> 
